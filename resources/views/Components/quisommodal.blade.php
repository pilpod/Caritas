<article>
    <h2 class="text-h2 flex justify-center mb-6">QUIENES SOMOS</h2>
    <div class="flex justify-center">
        <img class="w-3/4 mb-4"src="{{ asset('storage/img/quisom.jpg') }}" alt="Caritas Logo"/>
    </div>
    <p class="text-ui-tiny mx-6 my-4">En mayo de 2020, en plena crisis por la pandémia del Covid19, un grupo de amigos y conocidos vinculados a la parróquia de Sant Josep de Badalona, pusimos en marcha un punto de distribución de alimentos para familias en situación de vulnerabilidad que Càritas y servicios sociales de Badalona nos fue derivando.
    ...
    El banco de alimentos tenía fecha de finalización pero debíamos aprovechar la movilización y predisposición de voluntarios, comercios y vecinos del barrio...Fruto de esta experiencia vino la reflexión de diferenciar la demanda urgente y apostar por un proyecto emancipador, de largo recorrido que promocione la autonomía del usuario. Limitarse a la distribución de alimentos a las familias no permite poder atender aspectos importantes como la acogida y la promoción integral de la persona. Por todo ello nació el proyecto de acompañamiento y soporte a familias vulnerables mediante la tarjeta monedero.</p>
