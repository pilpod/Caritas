<x-layout>
    ...
    <div class="container text-body mx-auto mt-20 w-1/2 border-red border-2 rounded-2xl p-10 relative">
        ...
        <form method="POST" action="{{ route('logo.update', $profile->id) }}"  enctype="multipart/form-data">
            ...
            <button class="block w-1/2 mx-auto bg-red hover:bg-red-lighter text-white font-bold py-2 px-4 rounded border-b-4 border-red-light" type="submit">Cargar</button>
        </form>
    </div>
</x-layout>
